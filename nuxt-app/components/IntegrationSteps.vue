...
:key="step.id"
class="fade-item relative flex min-h-[520px] flex-col rounded-[32px] bg-[#E9EBF2] p-8 xl:h-[520px] xl:p-10"
>
...
<div class="mt-auto flex h-[240px] items-end justify-center">
